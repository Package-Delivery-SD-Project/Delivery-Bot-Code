...
(cl:defmethod cl:initialize-instance :after ((m <MoveFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name scarab_msgs-msg:<MoveFeedback> is deprecated: use scarab_msgs-msg:MoveFeedback instead.")))

(cl:ensure-generic-function 'base_position-val :lambda-list '(m))
(cl:defmethod base_position-val ((m <MoveFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scarab_msgs-msg:base_position-val is deprecated.  Use scarab_msgs-msg:base_position instead.")
  (base_position m))
