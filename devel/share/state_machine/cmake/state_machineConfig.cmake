...
if("TRUE" STREQUAL "TRUE")
  set(state_machine_SOURCE_PREFIX /home/jared/delivery_bot_ws/src/state_machine)
  set(state_machine_DEVEL_PREFIX /home/jared/delivery_bot_ws/devel)
  ...
  set(state_machine_INSTALL_PREFIX /home/jared/delivery_bot_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'state_machine' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jared/delivery_bot_ws/src/state_machine/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT state_machine_NUM_DUMMY_TARGETS)
      set(state_machine_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::state_machine::wrapped-linker-option${state_machine_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR state_machine_NUM_DUMMY_TARGETS "${state_machine_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::state_machine::wrapped-linker-option${state_machine_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND state_machine_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(state_machine_EXPORTED_TARGETS ${${state_machine_dep}_EXPORTED_TARGETS})
endforeach()
