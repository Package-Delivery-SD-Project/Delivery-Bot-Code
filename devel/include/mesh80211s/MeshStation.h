...
struct MeshStation_
{
  ...
  _plid_type plid;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _plink_type;
  _plink_type plink;
...
bool operator==(const ::mesh80211s::MeshStation_<ContainerAllocator1> & lhs, const ::mesh80211s::MeshStation_<ContainerAllocator2> & rhs)
{
  return lhs.mac == rhs.mac &&
    lhs.device == rhs.device &&
    lhs.inactive_time == rhs.inactive_time &&
    lhs.rx_bytes == rhs.rx_bytes &&
    lhs.rx_packets == rhs.rx_packets &&
    lhs.tx_bytes == rhs.tx_bytes &&
    lhs.tx_packets == rhs.tx_packets &&
    lhs.signal == rhs.signal &&
    lhs.tx_bitrate == rhs.tx_bitrate &&
    lhs.llid == rhs.llid &&
    lhs.plid == rhs.plid &&
    lhs.plink == rhs.plink;
}
...
struct Printer< ::mesh80211s::MeshStation_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::mesh80211s::MeshStation_<ContainerAllocator>& v)
  {
    ...
    s << indent << "plink: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.plink);
  }
};
