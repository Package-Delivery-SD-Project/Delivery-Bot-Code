...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.left_duty_sp, _x.left_duty, _x.right_duty_sp, _x.right_duty, _x.left_qpps_sp, _x.left_qpps, _x.right_qpps_sp, _x.right_qpps, _x.left_sp, _x.left, _x.right_sp, _x.right, _x.v_sp, _x.v, _x.w_sp, _x.w, _x.left_pid_pe, _x.left_pid_ie, _x.left_pid_de, _x.right_pid_pe, _x.right_pid_ie, _x.right_pid_de,) = _get_struct_4d4i14d().unpack(str[start:end])
      return self
...
def _get_struct_I():
    global _struct_I
    return _struct_I
_struct_4d4i14d = None
def _get_struct_4d4i14d():
    global _struct_4d4i14d
    if _struct_4d4i14d is None:
        _struct_4d4i14d = struct.Struct("<4d4i14d")
    return _struct_4d4i14d
