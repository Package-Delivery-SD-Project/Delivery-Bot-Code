...
"""autogenerated by genpy from scarab_msgs/MoveActionResult.msg. Do not edit."""
import codecs
import sys
...
class MoveActionResult(genpy.Message):
  ...
  _type = "scarab_msgs/MoveActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','scarab_msgs/MoveResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = scarab_msgs.msg.MoveResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = scarab_msgs.msg.MoveResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.final_status,) = _get_struct_B().unpack(str[start:end])
      return self
