...
"""autogenerated by genpy from scarab_msgs/MoveAction.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  _slot_types = ['scarab_msgs/MoveActionGoal','scarab_msgs/MoveActionResult','scarab_msgs/MoveActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = scarab_msgs.msg.MoveActionGoal()
      if self.action_result is None:
        self.action_result = scarab_msgs.msg.MoveActionResult()
      if self.action_feedback is None:
        self.action_feedback = scarab_msgs.msg.MoveActionFeedback()
    else:
      self.action_goal = scarab_msgs.msg.MoveActionGoal()
      self.action_result = scarab_msgs.msg.MoveActionResult()
      self.action_feedback = scarab_msgs.msg.MoveActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_B3I().pack(_x.action_result.result.final_status, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.action_goal.goal.stop,) = _get_struct_B().unpack(str[start:end])
      ...
      (_x.action_result.result.final_status, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _get_struct_B3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
